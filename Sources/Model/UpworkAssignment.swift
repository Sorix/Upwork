...
public struct UpworkAssignment {
	typealias Myself = UpworkAssignment
	...
	internal init?(json: JSON) {
		...
		rate = Myself.getRate(json["as_rate"].stringValue)
		dateCompleted = Myself.getDateCompleted(json["as_to"].stringValue)
